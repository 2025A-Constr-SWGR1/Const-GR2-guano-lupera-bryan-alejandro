...
public class Planificacion {
    ...
    public Integer limiteComensales; // Límite máximo de comensales
    ...
    public Planificacion(String nombre, String hora, Integer limiteComensales) {
        this.nombre = nombre;
        this.hora = hora;
    ...
    public Integer getLimiteComensales() {
        return limiteComensales;
    }

    public void setLimiteComensales(Integer limiteComensales) {
        this.limiteComensales = limiteComensales;
    }
    ...
    public void addComensal(Comensal comensal) {
        ...
        if (this.comensales.contains(comensal)) {
            if (this.comensalPlanificador != null &&
                    comensal.getId() != null &&
                    comensal.getId().equals(this.comensalPlanificador.getId())) {
            }
            throw new IllegalArgumentException("El comensal ya está en esta planificación");
        }
        if (this.limiteComensales != null &&
                this.comensales.size() >= this.limiteComensales &&
                (this.comensalPlanificador == null ||
                        comensal.getId() == null ||
                        !comensal.getId().equals(this.comensalPlanificador.getId()))) {
            throw new IllegalArgumentException(
                    "Se ha alcanzado el límite máximo de comensales (" + this.limiteComensales + ")");
        }
    ...
    public void setComensalPlanificador(Comensal comensalPlanificador) {
        ...
        // Agregar automáticamente el planificador a la lista de comensales
        if (comensalPlanificador != null) {
            if (this.comensales == null) {
                this.comensales = new ArrayList<>();
            }
            // Solo agregar si no está ya en la lista
            if (!this.comensales.contains(comensalPlanificador)) {
                this.comensales.add(comensalPlanificador);
            }
        }
    }
