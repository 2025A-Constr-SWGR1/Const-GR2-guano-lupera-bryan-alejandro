    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/planificar" method="POST">
                ...
                <div class="mb-3">
                    <label for="limiteComensales" class="form-label">Límite de comensales</label>
                    <input type="number" class="form-control" id="limiteComensales" name="limiteComensales"
                           min="1" max="50" required placeholder="Ej: 10">
                    <div class="form-text">Número máximo de comensales que pueden unirse a esta planificación (1-50)</div>
                </div>
