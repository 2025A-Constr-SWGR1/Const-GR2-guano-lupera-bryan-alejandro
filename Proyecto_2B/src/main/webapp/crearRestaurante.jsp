<%@ page import="entidades.DuenioRestaurante" %>
<%@ page import="entidades.Restaurante" %>
<%@ page import="java.util.List" %>
<%@ page import="entidades.Menu" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%
    // Verificar autenticación y tipo de usuario
    if (session.getAttribute("usuario") == null ||
        !(session.getAttribute("usuario") instanceof DuenioRestaurante)) {
...
<body>
    <div class="container mt-5">
                ...
                <div class="view-mode">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="view-content">
                            <%= restauranteUsuario.getNombre() !=null ?
                            restauranteUsuario.getNombre() : "N/A" %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Descripción</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getDescripcion() !=null ?
                            restauranteUsuario.getDescripcion() : "N/A" %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tipo de Comida</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getTipoComida() !=null ?
                            restauranteUsuario.getTipoComida() : "N/A" %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Precio Promedio</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getPrecio() %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Distancia de Universidad</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getDistanciaUniversidad() %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Horario de Atención</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getHoraApertura() !=null ?
                            restauranteUsuario.getHoraApertura() : "N/A" %> -
                            <%= restauranteUsuario.getHoraCierre() !=null ?
                            restauranteUsuario.getHoraCierre() : "N/A" %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tiempo de Espera (minutos)</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getTiempoEspera() %>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Calidad (1-5)</label>
                        <div class="view-content">
                            <%= restauranteUsuario.getCalidad() %>
                        </div>
                    </div>
                ...
                <div class="edit-mode">
                    <form action="${pageContext.request.contextPath}/restaurante" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="tipoComida" id="tipoComida" required>
                                <option value="Comida Rápida" <%="Comida Rápida"
                                    .equals(restauranteUsuario.getTipoComida())
                                    ? "selected" : "" %>>🍔 Comida Rápida</option>
                                <option value="Comida Casera" <%="Comida Casera"
                                    .equals(restauranteUsuario.getTipoComida())
                                    ? "selected" : "" %>>🍲 Comida Casera</option>
                                <option value="Comida Costeña" <%="Comida Costeña"
                                    .equals(restauranteUsuario.getTipoComida())
                                    ? "selected" : "" %>>🐟 Comida Costeña</option>
                                <option value="Platos a la Carta" <%="Platos a la Carta"
                                    .equals(restauranteUsuario.getTipoComida())
                                    ? "selected" : "" %>>🍽️ Platos a la Carta</option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" step="0.01" name="distanciaUniversidad" id="distanciaUniversidad"
                                required value="<%= restauranteUsuario.getDistanciaUniversidad() %>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label">Horario de Atención</label>
                            <div class="d-flex align-items-center">
                                <input type="time" class="form-control me-2" style="width: 150px;" name="horaApertura" required
                                    value="<%= restauranteUsuario.getHoraApertura() != null ? restauranteUsuario.getHoraApertura() : "" %>">
                                <span class="mx-2">a</span>
                                <input type="time" class="form-control ms-2" style="width: 150px;" name="horaCierre" required
                                    value="<%= restauranteUsuario.getHoraCierre() != null ? restauranteUsuario.getHoraCierre() : "" %>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="tiempoEspera" class="form-label">Tiempo de Espera (minutos)</label>
                            <input type="number" class="form-control" name="tiempoEspera" id="tiempoEspera" required min="0"
                                value="<%= restauranteUsuario.getTiempoEspera() %>">
                        </div>
                        <div class="mb-3">
                            <label for="calidad" class="form-label">Calidad (1-5)</label>
                            <input type="number" class="form-control" name="calidad" id="calidad" required min="1" max="5"
                                value="<%= restauranteUsuario.getCalidad() %>">
                        </div>
                ...
                <form action="${pageContext.request.contextPath}/restaurante" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="tipoComida" id="tipoComida" required>
                            ...
                            <option value="Platos a la Carta">🍽️ Platos a la Carta
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
        ...
        <div class="card shadow mt-4">
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <h6>Total de Likes: <%=
                            restauranteUsuario.getMenuDelDia().getCantidadVotos() %>
                    </h6>
                    <% } else { %>
                    <p class="text-muted">No hay menú del día registrado aún.
                    </p>
                    <% } %>
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalMenuDelDia">
                        <i class="fas fa-utensils me-2"></i>
                        <%= restauranteUsuario.getMenuDelDia() !=null
                        ? "Editar Menú del Día" : "Agregar Menú del Día"
                        %>
                    </button>
                </div>
                ...
                <!-- Menús Regulares -->
                <div class="mb-4">
                    <h5>Platos a la carta</h5>
                    <% if (restauranteUsuario.getMenus() !=null &&
                        !restauranteUsuario.getMenus().isEmpty()) { %>
                    <% for (Menu menu : restauranteUsuario.getMenus()) { %>
                    <div class="card mb-2">
                        <div class="card-body">
                            <%= menu.getContenido() %>
                        </div>
                    ...
                    <% } %>
                    <% } else { %>
                    <p class="text-muted">No hay menús registrados aún.
                    </p>
                    <% } %>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalMenu">
                        <i class="fas fa-plus me-2"></i> Agregar Nuevo Plato a la Carta
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modalMenuDelDia" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="${pageContext.request.contextPath}/restaurante" method="post">
                        <input type="hidden" name="accion" value="agregarMenuDelDia">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">Descripción del Menú del Día</label>
                                <textarea class="form-control" name="menuDelDia" placeholder="Describa el menú del día..." required
                                    rows="5"><%= restauranteUsuario.getMenuDelDia() != null ? restauranteUsuario.getMenuDelDia().getDescripcion() : "" %></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" class="btn btn-primary">Guardar Menú del Día</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <form action="${pageContext.request.contextPath}/restaurante" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="menu" placeholder="Describa el menú..." required
                                    rows="5"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
    ...
    <% String contenidoMenuDelDia=restauranteUsuario !=null &&
        restauranteUsuario.getMenuDelDia() !=null ?
        restauranteUsuario.getMenuDelDia().getDescripcion() : "" ; %>
    <script>
