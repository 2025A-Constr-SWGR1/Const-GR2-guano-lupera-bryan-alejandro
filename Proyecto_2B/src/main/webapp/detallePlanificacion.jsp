                ...
                <div class="alert alert-light">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <c:if test="${not empty planificacion.limiteComensales}">
                                <p><strong>Límite de comensales:</strong> ${planificacion.limiteComensales}</p>
                                <p><strong>Comensales actuales:</strong> ${planificacion.comensales.size()} / ${planificacion.limiteComensales}</p>
                            </c:if>
