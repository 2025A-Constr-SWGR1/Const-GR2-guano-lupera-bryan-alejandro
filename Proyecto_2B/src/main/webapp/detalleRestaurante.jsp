...
<fmt:formatNumber value="${restaurante.puntajePromedio}" maxFractionDigits="1" var="puntajeString"/>
                    ...
                    <c:if test="${not empty sessionScope.usuario && sessionScope.usuario.tipoUsuario == 'COMENSAL'}">
                        <div class="actions-container d-flex gap-2">
                            ...
                            <!-- Agregar botón de menú del día si existe -->
                            <c:if test="${not empty restaurante.menuDelDia}">
                                <button class="btn btn-outline-success d-flex align-items-center" 
                                    ...
                                    <i class="fas fa-utensils me-2"></i>Almuerzo del Día
                                </button>
                            </c:if>
                        </div>
                    </c:if>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Menú del Día - ${restaurante.nombre}</h5>
...
document.addEventListener('DOMContentLoaded', function () {
    // Inicializar botones de voto para menú del día
