        ...
        <div class="container mx-auto mt-12 px-4 max-w-md">
            ...
            <form action="${pageContext.request.contextPath}/login" method="post"
                ...
                <div class="mb-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
                    <div class="flex items-center mb-3">
                        ...
                        <span class="text-sm font-semibold text-blue-700">Credenciales de prueba (Usuario /
                            Contraseña):</span>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                        <div class="bg-white p-2 rounded border-l-4 border-green-400">
                            <div class="font-medium text-gray-700 mb-1">👤 Comensales</div>
                        ...
                        <div class="bg-white p-2 rounded border-l-4 border-orange-400">
                            <div class="font-medium text-gray-700 mb-1">🍽️ Restaurantes</div>
                            <div class="text-orange-600 space-y-1">
                                <div>• r1 / r1</div>
                                <div>• r2 / r2</div>
                                <div>• r3 / r3</div>
                                <div>• r4 / r4</div>
            ...
            <p class="text-center text-gray-600">
                ...
                <a href="${pageContext.request.contextPath}/registro.jsp"
                    class="text-blue-600 hover:text-blue-800">Regístrate
                    aquí</a>
            </p>
        </div>
    </body>
