...
<%@ page import="servicios.ComparacionService" %>
<!DOCTYPE html>
<html>
<head>
...
<div class="container mt-5">
    <%
        ...
        if (restaurante1 != null && restaurante2 != null) {
            ComparacionService comparacion = new ComparacionService(restaurante1, restaurante2);
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><fmt:formatNumber value="${restaurante1.puntajePromedio}" type="number" minFractionDigits="2" maxFractionDigits="2"/> ★</td>
                        <td><fmt:formatNumber value="${restaurante2.puntajePromedio}" type="number" minFractionDigits="2" maxFractionDigits="2"/> ★</td>
                    </tr>
                    <tr>
                ...
                <%
                    double[] promediosRest1 = (double[]) session.getAttribute("promediosRest1");
                    double[] promediosRest2 = (double[]) session.getAttribute("promediosRest2");
                    String[] atributos = {
                        "Calidad Comida", "Calidad Servicio", "Limpieza", "Ambiente",
                        "Tiempo Espera", "Relación Precio/Calidad", "Variedad Menú", "Accesibilidad", "Volvería"
                    };
                %>
                <div class="card mt-4">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Promedio Detallado de Calificaciones</h4>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tr>
                                    <th>Atributo</th>
                                    <th><%= restaurante1.getNombre() %></th>
                                    <th><%= restaurante2.getNombre() %></th>
                                </tr>
                                <% for (int i = 0; i < atributos.length; i++) { %>
                                <tr>
                                    <td><%= atributos[i] %></td>
                                    <td><%= String.format("%.2f", promediosRest1[i]) %></td>
                                    <td><%= String.format("%.2f", promediosRest2[i]) %></td>
                                </tr>
                                <% } %>
                            </table>
                        </div>
